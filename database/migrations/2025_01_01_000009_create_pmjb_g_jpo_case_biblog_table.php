...
return new class extends Migration
{
    ...
    {
        Schema::create('pmjb_g_jpo_case_biblog', function (Blueprint $table) {
            ...
            $table->index('app_num', 'idx_pmjb_g_jpo_case_biblog_app_num');
        });
    }
    ...
    {
        Schema::dropIfExists('pmjb_g_jpo_case_biblog');
    }
};
