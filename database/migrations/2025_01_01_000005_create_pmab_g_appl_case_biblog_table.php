...
return new class extends Migration
{
    ...
    {
        Schema::create('upd_pmab_g_appl_case_biblog', function (Blueprint $table) {
            ...
            $table->text('abin_delete_flg')->nullable();
            $table->text('abin_invent_title')->nullable();
            $table->text('abaa_delete_flg')->nullable();
            $table->text('abii_delete_flg')->nullable();
            $table->text('abti_delete_flg')->nullable();
            $table->text('abds_delete_flg')->nullable();
            $table->text('abpl_delete_flg')->nullable();
            $table->text('abpl_dspst_content')->nullable();
            $table->text('abpl_patent_num')->nullable();
            $table->text('abpl_dspst_dt')->nullable();
            $table->text('abpl_ext_period')->nullable();
            ...
            $table->unique(['law_cd', 'app_num'], 'upd_pmab_g_appl_case_biblog_main_ids');
            $table->index('app_num', 'idx_upd_pmab_g_appl_case_biblog_app_num');
        });
    }
    ...
    {
        Schema::dropIfExists('upd_pmab_g_appl_case_biblog');
    }
};
