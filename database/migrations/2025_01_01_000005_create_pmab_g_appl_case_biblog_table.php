...
return new class extends Migration
{
    ...
    {
        Schema::create('pmab_g_appl_case_biblog', function (Blueprint $table) {
            ...
            $table->char('abin_delete_flg', 1)->nullable();
            $table->text('abin_invent_title')->nullable();
            $table->char('abaa_delete_flg', 1)->nullable();
            $table->char('abii_delete_flg', 1)->nullable();
            $table->char('abti_delete_flg', 1)->nullable();
            $table->char('abds_delete_flg', 1)->nullable();
            $table->char('abpl_delete_flg', 1)->nullable();
            $table->string('abpl_dspst_content', 50)->nullable();
            $table->string('abpl_patent_num', 50)->nullable();
            $table->string('abpl_dspst_dt', 8)->nullable();
            $table->string('abpl_ext_period', 50)->nullable();
    ...
    {
        Schema::dropIfExists('pmab_g_appl_case_biblog');
    }
};
