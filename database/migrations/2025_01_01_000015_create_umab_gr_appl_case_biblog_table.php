...
return new class extends Migration
{
    ...
    {
        Schema::create('upd_umab_gr_appl_case_biblog', function (Blueprint $table) {
            ...
            $table->text('abna_newapp_app_dt')->nullable();
            ...
            $table->text('abde_device_creator_name')->nullable();
            $table->text('abde_device_creator_addr')->nullable();
            ...
            $table->text('abae_representative_name')->nullable();
            $table->text('abae_office_addr')->nullable();
            $table->text('abae_wrk_place_addr')->nullable();
            ...
            $table->text('aban_representative_name')->nullable();
            $table->text('aban_office_addr')->nullable();
            $table->text('aban_wrk_place_addr')->nullable();

            $table->unique(['law_cd', 'app_num', 'article_id', 'repeat_num'], 'upd_umab_gr_appl_case_biblog_main_ids');
            $table->index('app_num', 'idx_upd_umab_gr_appl_case_biblog_app_num');
            $table->index('article_id', 'idx_upd_umab_gr_appl_case_biblog_article_id');
        });
    }
    ...
    {
        Schema::dropIfExists('upd_umab_gr_appl_case_biblog');
    }
};
