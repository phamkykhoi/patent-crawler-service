...
return new class extends Migration
{
    ...
    {
        Schema::create('upd_umjb_gr_jpo_case_biblog', function (Blueprint $table) {
            ...
            $table->unique(['law_cd', 'app_num', 'article_id', 'repeat_num'], 'upd_umjb_gr_jpo_case_biblog_main_ids');
            $table->index('app_num', 'idx_upd_umjb_gr_jpo_case_biblog_app_num');
            $table->index('article_id', 'idx_upd_umjb_gr_jpo_case_biblog_article_id');
        });
    }
    ...
    {
        Schema::dropIfExists('upd_umjb_gr_jpo_case_biblog');
    }
};
