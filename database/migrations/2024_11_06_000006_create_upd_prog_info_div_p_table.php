...
return new class extends Migration
{
    ...
    {
        Schema::create('upd_prog_info_div_p', function (Blueprint $table) {
            ...
            $table->unique(['law_cd', 'reg_num', 'pe_num'], 'upd_prog_info_div_p_main_ids');
    ...
    {
        Schema::dropIfExists('upd_prog_info_div_p');
    }
};
