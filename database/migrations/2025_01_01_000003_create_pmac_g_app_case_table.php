...
return new class extends Migration
{
    ...
    {
        Schema::create('upd_pmac_g_app_case', function (Blueprint $table) {
            ...
            $table->unique(['law_cd', 'app_num'], 'upd_pmac_g_app_case_main_ids');
            $table->index('app_num', 'idx_upd_pmac_g_app_case_app_num');
        });
    }
    ...
    {
        Schema::dropIfExists('upd_pmac_g_app_case');
    }
};
